...
if (!envValidation.isValid) {
  logger.error('Environment validation failed. Application may not work correctly.', { errors: envValidation.errors });
...
logger.info(`Campus2Career starting in ${getEnvironment()} mode`);
