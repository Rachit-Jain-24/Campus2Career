...
export const BatchAnalytics: React.FC<BatchAnalyticsProps> = ({ 
    ...
    useEffect(() => {
        ...
        const unsubscribe = studentsDb.onStudentsChange((updatedStudents) => {
            const filtered = updatedStudents.filter((s: any) => 
            ...
            const studentsData: BatchStudent[] = filtered.map((data: any) => ({
                ...
                projects: data.project_list || data.projects || [],
                certifications: data.certification_list || data.certifications || [],
                internships: data.internship_list || data.internships || []
            }));
