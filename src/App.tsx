...
// Portal selector for admin roles
...
function App() {
  ...
  return (
    <>
      <Routes>
        {/* ── Unified Auth Page (Login/Signup for Students & Admins) ── */}
        ...
        <Route path="/login/dean" element={<Navigate to="/auth" replace />} />
        <Route path="/login/director" element={<Navigate to="/auth" replace />} />
        <Route path="/login/program-chair" element={<Navigate to="/auth" replace />} />
        <Route path="/login/faculty" element={<Navigate to="/auth" replace />} />
        <Route path="/login/placement-officer" element={<Navigate to="/auth" replace />} />
        ...
        <Route path="/student/drives" element={<ProtectedRoute allowedRole="student" requireAssessment><DrivesPage /></ProtectedRoute>} />
        ...
        {/* Convenience aliases - all redirect to unified auth */}
        <Route path="/student-login" element={<Navigate to="/auth" replace />} />
        <Route path="/admin-login" element={<Navigate to="/auth" replace />} />
        <Route path="/dean-login" element={<Navigate to="/auth" replace />} />
      </Routes>
