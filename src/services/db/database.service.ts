import {
  ...
  supabaseApplications, supabaseNotifications
...
import type { 
  ...
  ApplicationAdapter, NotificationAdapter
} from './types';
...
export const applicationsDb: ApplicationAdapter = supabaseApplications;
export const notificationsDb: NotificationAdapter = supabaseNotifications;
